...
from .models import Slide, Lesson, LearningEvent, Profile, Section, Class, School
...
# This section registers the "section" model and also changes the field 'teacher' so that only users are listed who are teachers
